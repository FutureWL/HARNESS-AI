...
- HTTPS：https://localhost:37211
- HTTP（自动跳转到 HTTPS）：http://localhost:37210
- 健康检查：
  - http://localhost:37210/healthz
  - https://localhost:37211/healthz

说明：

- 端口固定分配在 33200～33300 范围内，默认使用 37210（HTTP）和 37211（HTTPS）。
